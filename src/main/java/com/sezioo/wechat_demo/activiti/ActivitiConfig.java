package com.sezioo.wechat_demo.activiti;
...
public class ActivitiConfig {
    ...
    @Autowired
    public ActivitiConfig(DataSource dataSource, @Qualifier("transactionManager") PlatformTransactionManager platformTransactionManager) {
    ...
    public SpringProcessEngineConfiguration springProcessEngineConfiguration() {
        ...
        try {
            ...
            System.out.println("resource size : "+resources.length);
        } catch (IOException e) {
            e.printStackTrace();
        }
